        ...
        <?php while ($row = mysqli_fetch_array($search_result)) : ?>
          ...
          ?>
            <tr class="displayRow">
              ...
              <td><a class="displayResearch" target='_blank' href='display.php?id=<?php echo $row['id']; ?>'><i class='far fa-file-alt' style="font-size: 80px; "></i>
                  ...
                  <p style="margin-left: 90px; ">
                    ...
                    <p style="margin-left: 90px; "><?php echo $row['publication_day'] . ' ' . $row['publication_month'] . ' ' . $row['publication_year']; ?></p>
                    <hr>
                </a>
              </td>
            </tr>
