...
<script type="text/javascript" src="script.js"></script>-->
      <h3 style="margin-left: 35px;">Results:<h3>
          ...
          <div class="circle" style="display: flex; ">
            <div class="unique">90%</div>
            <p style="font-weight:bold; margin-top:20px">UNIQUE</p>
            <div class="plagiarized">10%</div>
            <p style="font-weight:bold; margin-top:20px">Plagiarized</p>
            <div class="checked">100%</div>
            <p style="font-weight:bold;">COMPLETED: 100% CHECKED</p>
          </div>
